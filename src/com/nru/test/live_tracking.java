...
/**
 * Servlet implementation class live_tracking
 */
public class live_tracking extends HttpServlet {
	...
	public void myAction(HttpServletRequest request, HttpServletResponse response, String method) throws ServletException, IOException {
		...
		if(session.getAttribute("email") == null){
			...
			request.getRequestDispatcher("live_tracking.jsp").forward(request, response);
		}
	}
